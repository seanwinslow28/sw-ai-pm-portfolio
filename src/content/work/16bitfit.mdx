...
<InvestigationBoard>
  ...
  <BoardArtifact
    ...
    excerpt="Design locked. 6 champions, cosmetic only, no stat-bearing advantage (the Mario Party model). Battle outcomes are victory or continue_training. There is no defeat state, by design.">
