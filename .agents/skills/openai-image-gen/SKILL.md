...
User: "Generate the Substack header for the 'Vault Said Nothing' post — Sedaris voice,
       Steadman aesthetic."
Codex: [Uses openai-image-gen] Reads the post .md to extract POST_TITLE + POST_SUBJECT.
...
Codex: [Uses openai-image-gen] Applies 7-Layer Framework:
...
Codex: [Uses openai-image-gen] Reads references/universal-prompt-templates.md
