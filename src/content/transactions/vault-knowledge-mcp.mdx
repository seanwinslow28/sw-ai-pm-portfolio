...
# ↑ Points at the scorecard architecture page (/architecture/vault-scorecard/) —
#   the prior-art doc this MCP self-justifies against. The MCP's own architecture
#   writeup can take the vault-knowledge-mcp arch slug when it ships.
