...
# PUBLISHED 2026-06-01 (pulled forward from 2026-06-19 per launch-day
# critique). Editorial em-dash pass complete: the body's deliberate em-dash
# breath marks were re-punctuated to commas/colons/parens/periods per
# DESIGN.md, voice and rhythm preserved (no words changed).
status: PUBLISHED
tags:
  - meaning-layer
  - agents
...
roleMap:
  ...
  rows:
    ...
    - buyer: "Manus / Adept / browser-use / OpenAI Operator"
      ...
      isNegativeSpace: true                        # negative-space callout — not on Sean's target list; renders italic + em-dash (no JD)
...
This is the bet behind every artifact I've shipped in the last six weeks. The framing isn't mine; [Nate Jones named it on May 5th](https://natesnewsletter.substack.com) said it cleaner than I could:
