...
Codex: [Uses astro-framework] Creates src/pages/about.astro with
...
Codex: [Uses astro-framework] Creates React component in
...
Codex: [Uses astro-framework] Creates src/pages/work/[slug].astro
