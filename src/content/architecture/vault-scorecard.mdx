...
# OQ-C resolved 2026-05-29: the upstream sources shipped to code-brain
# main, so both URLs now point at the live files. The MDX body below
# still carries the 4 canonical h2 headings as an inline-body 4Q fallback.
essaySourceUrl: https://github.com/seanwinslow28/code-brain/blob/main/docs/VAULT_AS_AGENT_INFRASTRUCTURE.md
explanationUrl: https://github.com/seanwinslow28/code-brain/blob/main/docs/VAULT_AS_AGENT_INFRASTRUCTURE_EXPLANATION.md
