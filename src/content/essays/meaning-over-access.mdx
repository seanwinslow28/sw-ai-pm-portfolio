...
# status DRAFT per SHIP-PLAN D5 — manifesto publishes 2026-06-19; staged DRAFT
# does not gate v1 launch. Flip to PUBLISHED on publish day.
# PRE-PUBLISH (before flipping to PUBLISHED): run the editorial em-dash pass.
# DESIGN.md bans em dashes in editorial prose (essays included); this body
# still carries ~25 as a deliberate voice device. Resolve through
# writing-voice-modes during the voice pass, not mechanically.
status: DRAFT
tags:
  - meaning-layer
  - agents
